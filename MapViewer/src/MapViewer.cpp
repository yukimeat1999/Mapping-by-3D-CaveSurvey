...
void visualizeCloud(CloudT::Ptr cloud, const std::string& PointName) {
    ...
    pcl::visualization::PCLVisualizer viewer("Uncolored Point Cloud Viewer");
    viewer.addPointCloud(cloud, "uncolored cloud");
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 6, "uncolored cloud");
...
void visualizeCloud(ColorCloudT::Ptr cloud, const std::string& PointName) {
    RedirectVTKOutputWindow();
    pcl::visualization::PCLVisualizer viewer("Colored Point Cloud Viewer");
    pcl::visualization::PointCloudColorHandlerRGBField<ColorPointT> rgb(cloud);
    viewer.addPointCloud<ColorPointT>(cloud, rgb, "colored cloud");
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 6, "colored cloud");
    viewer.setBackgroundColor(1.0, 1.0, 1.0);
    viewer.addCoordinateSystem(1.0, "coordinate system", 0);
    viewer.initCameraParameters();
    viewer.setCameraPosition(0.0, 0.0, 100.0, // カメラ位置 (x, y, z)
