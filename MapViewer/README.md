...
データポートから読み込んだデータの表示方法を選択する．<br/><br/>One_at_a_Time: データポートのデータを一つずつ表示<br/>SameTime: データポートのデータを画面に同時に配置 
...
Please switch the display contents.<br/><br/>EMap: Only the elevation map is displayed.<br/>EMap_PlanWall: Display both.<br/>PlanWall: Only the walls of the cave are displayed.
...
<table>
  ...
  <tr>
    <td>Constraint</td>
    <td>(EMap, EMap_PlanWall, PlanWall)</td>
    <td>(EMap, EMap_PlanWall, PlanWall)</td>
  </tr>
  <tr>
    <td>Range</td>
