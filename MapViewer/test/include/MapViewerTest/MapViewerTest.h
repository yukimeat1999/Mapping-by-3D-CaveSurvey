...
/*!
 * @file  MapViewerTest.h
 * @brief Map Visualization (test code)
 *
 */
// </rtc-template>

#ifndef MAPVIEWER_TEST__H
#define MAPVIEWER_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  MapViewerTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~MapViewerTest() override;
 ...
 protected:
  ...
  /*!
   */
  RTC::OutPort<PointCloudTypes::PointCloud> m_ContourOut;
...
extern "C"
{
  DLL_EXPORT void MapViewerTestInit(RTC::Manager* manager);
};

#endif // MAPVIEWER_TEST_H
