...
Measurement System for 3D point cloud data creation component using 2D LiDAR and Dynamixel.
...
Set "DEVICE_NAME" and "BAUDRATE".<br/>[Windows]: \\\\.\\COM*
