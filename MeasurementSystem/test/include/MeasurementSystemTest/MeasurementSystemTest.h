  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  MeasurementSystemTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~MeasurementSystemTest() override;
...
extern "C"
{
  DLL_EXPORT void MeasurementSystemTestInit(RTC::Manager* manager);
};

#endif // MEASUREMENTSYSTEM_TEST_H
