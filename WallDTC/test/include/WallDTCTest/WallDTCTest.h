...
#ifndef WALLDTC_TEST__H
#define WALLDTC_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  WallDTCTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~WallDTCTest() override;
...
extern "C"
{
  DLL_EXPORT void WallDTCTestInit(RTC::Manager* manager);
};

#endif // WALLDTC_TEST_H
