...
rem System shutdown
rem RTC Deactive
rem rtdeact /localhost/%COMPUTERNAME%.host_cxt/EtheURG0.rtc
rem rtdeact /localhost/%COMPUTERNAME%.host_cxt/MeasurementSystem0.rtc
...
rtdis ^
/localhost/%COMPUTERNAME%.host_cxt/PointCloud_Reader0.rtc:new_PointCloud ^
...
rem rtexit /localhost/%COMPUTERNAME%.host_cxt/EtheURG0.rtc
