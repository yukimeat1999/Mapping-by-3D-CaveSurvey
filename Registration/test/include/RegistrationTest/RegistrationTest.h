...
#ifndef REGISTRATION_TEST__H
#define REGISTRATION_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  RegistrationTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~RegistrationTest() override;
...
extern "C"
{
  DLL_EXPORT void RegistrationTestInit(RTC::Manager* manager);
};

#endif // REGISTRATION_TEST_H
