...
#ifndef ANALYSES_TEST__H
#define ANALYSES_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  AnalysesTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~AnalysesTest() override;
...
extern "C"
{
  DLL_EXPORT void AnalysesTestInit(RTC::Manager* manager);
};

#endif // ANALYSES_TEST_H
